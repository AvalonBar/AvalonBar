        ...
        public static UpdateInfo CheckForUpdates(int build)
        {
            ...
            try
            {
                ...
                while (!reader.EndOfStream)
                {
                    ...
                    if (line.Contains(@"Update.info\x3fdownload', downloadUrl:"))
                    {
                        reader.Close();
                        response.Close();

                        line = line.Substring(line.IndexOf(@"Update.info\x3fdownload', downloadUrl:") + (@"Update.info\x3fdownload', downloadUrl:").Length + 2, line.IndexOf(@"Update.info\x3fdownload', demoteUrl:") - line.IndexOf(@"Update.info\x3fdownload', downloadUrl:") - 17);
