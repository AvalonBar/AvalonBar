    ...
    public class UpdateDialog
    {
        ...
        private static string GetDirectLink()
        {
            ...
            while (!reader.EndOfStream)
            {
                ...
                if (line.Contains(@"Update.data\x3fdownload', downloadUrl:"))
                {
                    reader.Close();
                    response.Close();

                    line = line.Substring(line.IndexOf(@"Update.data\x3fdownload', downloadUrl:") + (@"Update.data\x3fdownload', downloadUrl:").Length + 2, line.IndexOf(@"Update.data\x3fdownload', demoteUrl:") - line.IndexOf(@"Update.data\x3fdownload', downloadUrl:") - 17);
