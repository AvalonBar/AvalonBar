...
//Copyright (c) The LayerFX Project.
...
namespace Microsoft.WindowsAPICodePack.Dialogs
{
    ...
    /// </summary>
    public abstract class TaskDialogRTBBase : TaskDialogControl
    {
        
        /// <summary>
        /// Creates a new instance on a task dialog button.
        /// </summary>
        protected TaskDialogRTBBase() { }
        /// <summary>
        ...
        protected TaskDialogRTBBase(string name, string content) : base(name)
        {
            this.text = content;
        }
